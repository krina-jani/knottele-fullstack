...
<div class="bg-white rounded-3xl shadow-sm border border-stone-100 overflow-hidden">
    ...
    <div class="p-8">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
            <div class="order-2 sm:order-1 w-full sm:w-auto flex-1 max-w-lg">
                <div class="relative w-full">
                    <input type="text" id="searchInput" placeholder="Search by name, SKU or category..."
                        class="pl-10 pr-4 py-2 rounded-xl border border-stone-200 bg-stone-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-white transition-all w-full text-stone-900 placeholder-stone-400 text-xs sm:text-sm shadow-2xs">
