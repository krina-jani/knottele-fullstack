        ...
        <div class="p-3 sm:p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                ...
                <div class="flex flex-wrap items-center gap-2 order-1 sm:order-2 w-full sm:w-auto">
                    ...
                    <button id="brandsColumnVisibilityBtn" class="btn-secondary btn-sm" title="Columns">
                        <i class="fas fa-columns text-xs"></i>
                        <span>Columns</span>
                    </button>
                    <!-- PDF Button (Small, PDF only) -->
                    <button id="brandsExportBtn" onclick="window.print()" class="btn-secondary btn-sm hover:text-red-600 hover:bg-stone-50" title="Export as PDF">
...
@push('scripts')
    <script>
        ...
        function initBrandsExport() {
            const brandsExportBtn = document.getElementById('brandsExportBtn');
            brandsExportBtn?.addEventListener('click', function() {
                window.print();
            });
        }
